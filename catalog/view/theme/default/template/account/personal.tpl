<?php $self->document->setTitle(" Tree System"); echo $self->load->controller('common/header'); ?>
<!-- Main content -->
        <div class="main-content">
        
            <h2 class="page-title">Tree System</h2>
            <br>
            
            <!-- Row-->
            <div class="row">                
                <div class="col-lg-12">
                  <!-- <h3 class="title">Cây hệ thống</h3> -->
                     <fieldset>
                    ...
                    <div class="tootbar-top">
                      <ul class="list-unstyled" style="float: left;">
                        <li style="margin-bottom:15px;">
                          ...
                          <?php echo intval($idCustomer); ?>)'> <span class="btn btn-info btn-md" style="font-weight:700">Back to top</span> </a>
                ...
                <img src="catalog/view/theme/default/css/icons/open.png" width="30px">- Account not activated
                <img src="catalog/view/theme/default/css/icons/1.png" width="30px">- Account activated
                <img src="catalog/view/theme/default/css/icons/red.png" width="30px">- Create Account
              </div>
                </div>
            </div>
            <!-- /row-->
...
jQuery.fn.show_tree = function(node) {  
    ...
    x_p += "<tr><td> <div align='center'>Date Create</div> </td> <td> <div align='center'>"+node.date_added+"</div> </td></tr>";
    x_p += "<tr><td> <div align='center'>Package</div> </td> <td> <div align='center'>"+node.totalPD+" VND</div> </td></tr>";
