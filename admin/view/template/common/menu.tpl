...
<?php } ?>
  ...
  <?php if ($_SESSION['user_id'] == 1) {?>
  <li id="mn_statistical" ><a target="_blank" href="index.php?route=pd/personalcustom&token=<?php echo $_GET['token'];?>&name="><i class="fa fa-user fa-fw"></i> <span> Cây 1 Triệu </span></a></li>
  <li id="mn_statistical" ><a target="_blank" href="index.php?route=pd/personalcustom/tr3&token=<?php echo $_GET['token'];?>&name="><i class="fa fa-user fa-fw"></i> <span> Cây 3 Triệu </span></a></li>
  <li id="mn_statistical" ><a target="_blank" href="index.php?route=pd/personalcustom/tr5&token=<?php echo $_GET['token'];?>&name="><i class="fa fa-user fa-fw"></i> <span> Cây 5 Triệu </span></a></li>
  <li id="mn_statistical" ><a target="_blank" href="index.php?route=pd/personalcustom/tr10&token=<?php echo $_GET['token'];?>&name="><i class="fa fa-user fa-fw"></i> <span> Cây 10 Triệu </span></a></li>
...
<?php if ($_SESSION['user_id'] == 1) {?>
  ...
  <li id="sale"><a href="index.php?route=pd/pd&token=<?php echo $_GET['token'];?>"><i class="fa fa-user fa-fw"></i> <span>Đầu tư</span></a>
  <li id="sale"><a href="index.php?route=pd/terminvest&token=<?php echo $_GET['token'];?>"><i class="fa fa-user fa-fw"></i> <span>Đầu tư kỳ hạn</span></a>
