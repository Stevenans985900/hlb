       ...
       <!-- <div class="navbar-form">
     	...
     	<table class="table table-bordered table-hover">
          ...
          <?php $stt = 1; $sum=0;
            ...
            <td><?php echo $value['term'] ?> Tháng</td>
     				<td><?php echo number_format($value['filled']) ?> VNĐ</td>
     				<?php if ($value['status'] == 0) {
                       echo '<td><span class="label label-default">Chờ xử lý</span><a href="index.php?route=pd/terminvest/showinvoice&transactionId='.$value['pd_number'].'&token='.$token.'"> <i class="fa fa-link"></i>
                              </a></td>';
                    } ?>
...
<script type="text/javascript">
    ...
    url = 'index.php?route=pd/terminvest&token=<?php echo $token; ?>';
